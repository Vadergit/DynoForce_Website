(function () {
  ...
  const translations = {
    de: {
      ...
      "manual.highlight.battery.value": "Nutzungsabhängig",
    ...
    en: {
      ...
      "manual.highlight.battery.value": "Usage-dependent",
    ...
    fr: {
      ...
      "manual.highlight.battery.value": "Selon l’usage",
    ...
    it: {
      ...
      "manual.highlight.battery.value": "Dipende dall’uso",
